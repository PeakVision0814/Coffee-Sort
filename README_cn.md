...
* **G35 动态硬件急停**：由 PLC 控制的启动许可信号（带 0.5 秒软件消抖）。机械臂在抓取/放置的高危环节实时监控，一旦信号丢失瞬间原位锁死。
...
* **Web 控制台**：基于 Flask 构建的现代化仪表盘，支持实时视频流监控、状态总览和全局自动化启停。
...
* **启动自动流水线**：在 Web 界面点击“启动自动分拣”，或对 AI 说“开始流水线”。在摄像头检测到物品，且 PLC 给出 G35 许可信号后，机械臂将自动抓取并寻找空槽位放置。
